...
do "$PSID/J333314 (2019)/J333314.do" // note - this will need to be updated to wherever the raw data you downloaded is - this is directly provided by PSID
do "$PSID/J333314 (2019)/J333314_formats.do" // note - this will need to be updated to wherever the raw data you downloaded is - this is directly provided by PSID - also need to direct this file where to save: "$PSID\PSID_full.dta"
do "$code/2019 analysis/x_rename_vars.do"
do "$code/2019 analysis/x_marital_history.do"
...
use "$PSID\PSID_full_renamed_2019.dta", clear
rename INTERVIEW_NUM_1968 main_per_id // these are backwards
rename X1968_PERSON_NUM_1968 main_fam_id
...
drop X1968_PERSON_NUM_2021 SEQ_NUMBER_2021 RELATION_2021 CDS_ELIGIBLE_2021 // not sure how these got here but I don't want 2021 because I have no data
...
save "$temp/2019/PSID_full_long.dta", replace
...
save "$temp/2019/PSID_data_long.dta", replace
